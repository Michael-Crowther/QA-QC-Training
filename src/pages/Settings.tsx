            ...
            {showChangePassword ? (
              ...
              <div className="searchTermForm">
                ...
                <div className="quiz-grid-container-settings">
                  <a className="grid-item-settings quizButton" target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSeVEQoRq8cuplQw7nwMa6Xu4xVlCJODdHBaQTraO9Q_wizsyg/viewform">
                    Ground Mounts</a>
                  <a className="grid-item-settings quizButton" target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSehjXCReYHLaD5m_tlMTKkCiVFbt7uYKLj8cEJsWOoR23KCtQ/viewform">
                    Roof Framing</a>
